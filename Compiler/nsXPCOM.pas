...
const
  ...
  NS_ISHENTRY_IID: TGUID = '{09fecea6-5453-43ba-bf91-3ff32618f037}';
  ...
  NS_IDOCSHELL_IID: TGUID = '{8adfb831-1053-4a19-884d-bcdad7277b4b}';
...
type
  ...
  nsIDOMToString = interface;

  nsIDOMNSHTMLElement = interface;
  nsIStringInputStream = interface;
 ...
 *)
  ...
  nsIDocShell = interface(nsISupports)
    ['{dc4daea1-b43d-406f-bd62-c2ee879192ad}']
    procedure loadStream(aStream: nsIInputStream; aURI: nsIURI; aContentType: nsACString; aContentCharset: nsACString; aLoadInfo: nsIDocShellLoadInfo);
  end;
  ...
  ['{a6cf9072-15b3-11d2-932e-00805f8add32}']
    function GetData: nsAString; safecall;
    property Data: nsAString read GetData;
  ...
  nsIDOMNSHTMLElement = interface(nsISupports)
    ...
    function GetInnerHTML(): nsAString; safecall;
    property innerHTML: nsAString read GetInnerHTML;
  end;

  nsIDOMToString = interface(nsISupports)
    ['{2a72e20f-e337-4822-8994-2e35b5550d03}']
    function GetToString(): nsAString; safecall;
    property toString: nsAString read GetToString;
  end;
  ...
  nsIDOMDOMStringList = interface(nsiSupports)
    ...
    function GetLength(): PRInt32; safecall;
    property length: PRInt32 read GetLength;
    function item(index: PRInt32): nsAString; safecall;
    function contains(str: nsAString): PRBool; safecall;
  end;

  //http://www.oxymoronical.com/experiments/xpcomref/applications/Firefox/1.5/interfaces/nsIDOMKeyEvent
  ...
  ['{09fecea6-5453-43ba-bf91-3ff32618f037}']
    ...
    property PostData: nsIInputStream read GetPostData;
  end;
  ...
  nsIStringInputStream = interface(nsIInputStream)
  ...
  ['{f15398a0-8018-11d3-af70-00a024ffc08c}']
    ...
    function GetProperty(aId: PRUint32): PRUint32; safecall;
  end;
